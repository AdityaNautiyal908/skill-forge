  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="../public/mcq.php?index=0">MCQ</a></li>
          ...
          ?>
            <tr class="<?= ($uid === (int)$_SESSION['user_id']) ? 'table-info' : '' ?>">
              ...
              <td class="fw-semibold">
                ...
                ?>
                  <a href="#" 
                      data-delete-href="../admin/admin_delete_user_submissions.php?user_id=<?= $uid ?>&return_to=<?= urlencode($_SERVER['REQUEST_URI']) ?>"
                      data-user-id="<?= $uid ?>"
...
<script src="../public/assets/js/leaderboard.js"></script>
</body>
</html>