...
<head>
    ...
    <style>
        /* (All your previous CSS styles remain unchanged here) */
...
Swal.fire({
    ...
    text: '<?= htmlspecialchars($message, ENT_QUOTES, 'UTF-8') ?>', // Added security flags
    background: '#3c467b',
    color: '#fff',
...
// (The rest of your extensive JavaScript for validation remains unchanged)
// ...
// --- PASTE YOUR EXISTING JAVASCRIPT VALIDATION LOGIC HERE ---
(function(){
