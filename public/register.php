        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                $welcome_body = "
                    ...
                    <p><a href='http://" . $_SERVER['HTTP_HOST'] . "/skill-forge/public/dashboard.php' style='padding: 10px 20px; background-color: #6d7cff; color: white; text-decoration: none; border-radius: 5px; display: inline-block;'>Go to Dashboard</a></p>
                    <p>Happy Coding!</p>
