...
document.querySelector('.rating-stars') && document.querySelector('.rating-stars').addEventListener('mouseleave', () => {
...
// Initialize star rating based on posted value (if form submission failed)
...
if (commentBox && charCountSpan) {
    ...
    charCountSpan.textContent = commentBox.value.length;
}


// --- Web animation ---
(function(){
    var canvas = document.getElementById('webComment'); 
    if (!canvas) return; 
